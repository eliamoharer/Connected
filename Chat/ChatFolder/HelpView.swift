...
struct HelpView: View {
    let privacyText: LocalizedStringKey = """
        **Privacy Policy**
        ...
        This privacy policy applies to the Connected app for mobile devices, together with any related services operated by Elia Moharer (collectively, the "Application"). Elia Moharer is hereby referred to as the "Service Provider".
        ...
        **What are my opt-out rights?**
        ...
        If you contact the Service Provider directly or voluntarily provide information by other means, you may request deletion of that information by contacting elia.moharer@gmail.com.
        ...
        **Changes**
        ...
        Previous versions of this Privacy Policy will be maintained and made available upon request by contacting the Service Provider at elia.moharer@gmail.com.
        ...
        **Contact Us**
        ...
        If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at elia.moharer@gmail.com.
        """
    
    let termsText: LocalizedStringKey = """
        **Terms & Conditions** These terms and conditions apply to the Connected app for mobile devices, together with any related services operated by Elia Moharer (collectively, the "Application"). Elia Moharer is hereby referred to as the "Service Provider".
        ...
        * Moderate, filter, or hide content that violates these Terms, applicable law, or the guidelines set out above
        ...
        The Application processes and stores data, including chat histories and AI-generated responses, locally on your own device. The Service Provider does not collect, access, or store this data on any external servers. It is your responsibility to maintain the security of your phone and access to the Application. The Service Provider strongly advises against jailbreaking or rooting your phone, which involves removing software restrictions and limitations imposed by the official operating system of your device. Such actions could expose your phone to malware, viruses, malicious programs, compromise your phone's security features, and may result in the Application not functioning correctly or at all.
        ...
        **AI-Generated Content and Limitation of Liability**
        
        **AI-Generated Content:** The Application acts as a local client wrapper that connects to separate language models. The Service Provider is not responsible for, and does not control, the accuracy, safety, or legality of the text generated by the third-party AI models connected to the Application by the user. 
        ...
        **Governing Law and Jurisdiction** These Terms and Conditions are governed by the laws of the jurisdiction in which the Service Provider is established, excluding conflict of law rules, except to the extent mandatory consumer protection laws provide otherwise.
        ...
        **DSA Compliance (Digital Services Act)** If the Application is an intermediary service as defined under the Digital Services Act (Regulation (EU) 2022/2065, "DSA"), the following provisions apply in addition to the terms above.
        
        **Point of Contact:** The Service Provider maintains a single point of contact for direct communication with EU authorities and recipients of the service, reachable at elia.moharer@gmail.com. Where the Service Provider is established outside the European Union, a legal representative in the EU has been designated in accordance with Article 13 of the DSA.
        ...
        **Changes to These Terms and Conditions**
        ...
        Previous versions of these Terms and Conditions will be maintained and made available upon request by contacting the Service Provider at elia.moharer@gmail.com.
        
        These terms and conditions are effective as of 2026-06-10
        
        **Contact Us**
        
        If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at elia.moharer@gmail.com.
        """
        ...
        NavigationStack {
            Form {
                Section(header: Text("Setup")) {
                    DisclosureGroup {
                        Text("First, ensure your server is running on a valid port.")
                    } label: {
                        Label {
                    ...
                    DisclosureGroup {
                        Text("Personally, I use oMLX for macOS, and LM Studio for Windows. Setup for oMLX is extremely easy, simply install the app, pick a model that fits your computer, and start the server!")
                    } label: {
                        Label {
