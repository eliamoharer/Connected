...
struct ToSView: View {
    ...
    let termsText: LocalizedStringKey = """
        These terms and conditions apply to the Connected app for mobile devices, together with any related services operated by Elia Moharer (collectively, the "Application"). Elia Moharer is hereby referred to as the "Service Provider".
            ...
            VStack(spacing: 16) {
                ...
                Button {
                    ...
                    Text("Accept and Continue")
                        .foregroundColor(Color("BackgroundColor")) // High-contrast inversion
                        .padding(16)
